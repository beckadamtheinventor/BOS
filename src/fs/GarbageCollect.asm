...
; .no_buffer_swap:
	; ld a,1
	; call gfx_SetDraw
	; ld hl,$D50000 ;set to 0xff to be used as scrap
	; push hl
	; pop de
	; inc de
	; ld (hl),$FF
...
; .compacting_loop:
	; xor a,a
	; cpir
	; jq nz,.done_compacting
	; push hl
	; pop de
; .compacting_len_loop:
	; cpi
	; jp po,.done_compacting
	; jq z,.compacting_len_loop
	; push hl
	; ex hl,de
	; ld de,(ix-3)
	; or a,a
