...
syslibs: $(call rwildcard,syslib,*.asm)
	...
	fasmg syslib/ti.asm obj/syslib/ti.bin
	fasmg syslib/util.asm obj/syslib/util.bin
	python add_file_to_rom.py --rom bin/BOSOSInited.rom obj/syslib/_.bin /sys/_ obj/syslib/fs.bin /sys/fs obj/syslib/gfx.bin /sys/gfx obj/syslib/gui.bin /sys/gui obj/syslib/os.bin /sys/os obj/syslib/str.bin /sys/str obj/syslib/sc.bin /sys/sc obj/syslib/sys.bin /sys/sys obj/syslib/ti.bin /sys/ti obj/syslib/th.bin /sys/th obj/syslib/util.bin /sys/util
